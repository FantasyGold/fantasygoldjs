...
const {
  logDecoder,
} = require("fantasygoldjs-ethjs-abi") as IETHABI
...
export interface IContractSendRequestOptions {
  /**
   * The amount in FGC to send. eg 0.1, default: 0
   */
  ...
  /**
   * FantasyGold price per gas unit, default: 0.00000001, min:0.00000001
   */
...
export class Contract {
   ...
   *      [solar](https://github.com/fantasygoldproject/solar). It includes the contract
   *      address, owner address, and ABI definition for methods and types.
   * @param opts - init options
   */
  constructor(private rpc: FantasyGoldRPC, public info: IContractInfo, opts: IContractInitOptions = {}) {
  ...
  /**
   * Executes contract method on your own local fantasygoldd node as a "simulation"
