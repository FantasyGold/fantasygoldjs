...
import { FantasyGoldRPC, IRPCWaitForLogsRequest, IPromiseCancel } from "./FantasyGoldRPC"
...
export class EventListener {
  ...
  constructor(private rpc: FantasyGoldRPC, private logDecoder: ContractLogDecoder) {
  }
