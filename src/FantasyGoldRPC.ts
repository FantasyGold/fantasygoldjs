import { FantasyGoldRPCRaw } from "./FantasyGoldRPCRaw"
...
/**
 * Transaction receipt returned by fantasygoldd
 */
...
/**
 * The raw log data returned by fantasygoldd, not ABI decoded.
 */
...
export class FantasyGoldRPC extends FantasyGoldRPCRaw {
